...
class PCCExport implements FromView, WithEvents
{
    protected $data = '';
    ...
    {
        return view('inventory_report.pcc_report', $this->data);
    }
    ...
    public function registerEvents(): array
    {
        return [
            ...
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $arrColumn = ['AN', 'AO', 'AP', 'AQ', 'AR', 'AS', 'AT', 'AU', 'AV', 'AW', 'AX', 'AY'];
                ...
                for ($i = $initRow; $i <= $endingRowDetail; $i++) {
                    $event->sheet->getDelegate()->getStyle("A{$i}:{$endingColumnName}{$i}")
                        ->getNumberFormat()
